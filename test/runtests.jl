...
@testset "CZML.jl" begin
    ...
    @testset "CZML Rectangle" begin
        # https://sandcastle.cesium.com/?src=CZML%20Rectangle.html&label=CZML
        str_CZML = """[
          {
            id: "document",
            ...
            rectangle = Rectangle(;
                ...
                material = Material(;
                    stripe = StripeMaterial(;
                        ...
                        oddColor = Color(; rgba = [0, 0, 255, 255]),
                        repeat = 5,
                    ),
                ),
            ),
    ...
    @testset "CZML Polyline Volume" begin
        # https://sandcastle.cesium.com/?src=CZML%20Polyline%20Volume.html&label=CZML
        str_CZML = """[
            {
              id: "document",
    ...
    @testset "CZML zIndex" begin
        # https://sandcastle.cesium.com/?src=CZML%20ZIndex.html&label=CZML
        str_CZML = """[
            {
              id: "document",
              name: "CZML zIndex",
            ...
            rectangle = Rectangle(;
                ...
                material = Material(;
                    stripe = StripeMaterial(;
                        ...
                        oddColor = Color(; rgba = [255, 0, 255, 255]),
                        repeat = 5,
                    ),
                ),
            ),
    ...
    @testset "CZML Reference Properties" begin
        # https://sandcastle.cesium.com/?src=CZML%20Reference%20Properties.html&label=CZML
        str_CZML = """[
            {
              id: "document",
        ...
        p0 = Preamble(;
            ...
            clock = Clock(;
                interval = TimeInterval(;
                    startTime = DateTime(2012, 8, 4, 10, 0, 0),
                    endTime = DateTime(2012, 8, 4, 15, 0, 0),
                ),
                currentTime = DateTime(2012, 8, 4, 10, 0, 0),
                multiplier = 10,
            ),
        )
        p1 = Packet(;
